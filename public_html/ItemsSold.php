...
// Connect to MySQL
	...
	$query_select = "SELECT Inventory.Productname, Transaction.Quantity_bought as Quantity, Transaction.Cost FROM Transaction INNER JOIN Inventory ON Transaction.Pid=Inventory.Pid WHERE Transaction.Seller='$username';";
