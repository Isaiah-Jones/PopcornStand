...
// Connect to MySQL
    ...
    if(!$default){
	 ...
	 $query_select = "SELECT Inventory.Productname, Sells.Quantity, Sells.Price as Cost, Sells.Seller FROM Inventory INNER JOIN Sells ON Inventory.Pid=Sells.Inventory_Pid WHERE Sells.Seller='$username';";
